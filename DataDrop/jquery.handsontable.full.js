...
function createContextMenu() {
  ...
  function onContextClick(key) {
    ...
    switch (key) {
      ...
      case "row_below":
        instance.alter("insert_row", corners[2] + 50);
        break;
